...
public class Solution1WithServicesTests {
    ...
    public Solution1WithServicesTests(ServiceFactory factory, ITestOutputHelper output) {
        _output = output;
    ...
    public async Task Solution5UnParkScooter00Test() {
        ...
        if (vehicle.Data is not null) {
            ...
            if (ticket is not null) {
                _output.WriteLine(JsonLogger.Log(ticket));
                _output.WriteLine($@"
Parking Ticket:
==============
Vehicle: {ticket!.Vehicle!.RegistrationNo}
